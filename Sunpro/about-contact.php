...
$contact_google_address_embed_code = get_field('contact_google_address_embed_code', get_the_ID());
$about_us_heading = get_field('about_us_heading', get_the_ID());
$about_us_short_description = get_field('about_us_short_description', get_the_ID());
$contact_us_heading = get_field('contact_us_heading', get_the_ID());
$contact_us_short_description = get_field('contact_us_short_description', get_the_ID());
$contact_us_form_code = get_field('contact_us_form_code', get_the_ID());
                ...
                <div class="addressBox">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="tel:<?php _e($contact_number); ?>"><?php _e($contact_number); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<section class="map__section">
    <div class="container maxw--1170 mx-auto">
        <h2 class="addressBox--title before--none text-center">
            <?php _e($contact_us_heading); ?>
        </h2>
        <p class="addressBox--text text-center mt-2">
            <?php _e($contact_us_short_description); ?>
        </p>
        <div class="row">
            <?php _e(do_shortcode($contact_us_form_code)); ?>
        </div>
    </div>
</section>
