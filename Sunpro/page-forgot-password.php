...
<div class="container page-template--forgot-password mt-ng-250">
                ...
                <div class="login_thumbcontent">
                    ...
                    <form class="user_form" id="wp_pass_reset" method="post">
                        <div class="form__auth__control">
                            <input type="email" name="enter_email_address" id="enter_email_address" autocomplete="off" class="form__auth--text js_form-input">
                            <label for="enter_email_address" class="form__auth--label email-label">Email
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="row mt-3">
