...
<div class="container mt-ng-250">
    <div class="login__wrapperBox">
        <div class="row">
            <div class="col-md-6">
                <div class="login_thumbcontent register--div">
                    <h1 class="login_thumbcontent--text">
                        Create an account
                    </h1>
                    <p class="signup--text">
                        Already have an account? <a href="<?php bloginfo('url'); ?>/login">SignIn</a>
                    </p>
                    <?php $register_form_shortcode = get_field('register_form_shortcode', 'options');
                    if ($register_form_shortcode) : ?>
                    ...
                    <form method="POST" id="registration_form" name="registration_form">
                        <div class="form__auth__control">
                            <input type="text" name="first_name" id="first_name" value="" class="form__auth--text js_form-input">
                            <label for="first_name" class="form__auth--label fname-label">First Name
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="form__auth__control">
                            <input type="text" name="last_name" id="last_name" value="" class="form__auth--text js_form-input">
                            <label for="last_name" class="form__auth--label lname-label">Last Name
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="form__auth__control">
                            <input type="text" name="company" id="company" value="" class="form__auth--text js_form-input">
                            <label for="company" class="form__auth--label lname-label">Company
                            </label>
                        </div>
                        <div class="form__auth__control">
                            <input type="email" name="your_email" id="your_email" value="" class="form__auth--text js_form-input">
                            <label for="your_email" class="form__auth--label email-label">Email
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="form__auth__control">
                            <input type="Password" name="your_password" id="your_password" class="form__auth--text js_form-input">
                            <label for="user_pass" class="form__auth--label password-label">Password
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="form__auth__control">
                            <input type="Password" name="confirm_password" id="confirm_password" class="form__auth--text js_form-input">
                            <label for="user_conpass" class="form__auth--label confirm-password-label">Confirm Password
                                <sub>*</sub>
                            </label>
                        </div>
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="agree">you agree to the <a href="<?php bloginfo('url'); ?>/privacy-policy">Privacy Policy</a> and <a href="<?php bloginfo('url'); ?>/terms-of-service">Terms of Service.</a>
                                    </label>
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                <input type="hidden" name="token" id="token">
                                <input type="hidden" name="hidden_value" id="hidden_value" value="RegisterUser">
